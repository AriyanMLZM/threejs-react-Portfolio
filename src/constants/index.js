...
export const projects = [
  {
    ...
    techs: 'react tailwind threejs blender',
    text: 'Unique fully 3d website, The combination of Blender power and Threejs to create a scene to explore with animations. The 3d models and the animations were made with Blender. The powerful css framework Tailwind was used as style. Then everything was put to work with React Threejs.',
  ...
  },
  {
    ...
    text: 'A Fullstack Parallax website that works with the scrolling of user. The frontend is developed with React and pure Css and the backend is developed with Express and the Sequelize as ORM and mySQL as Database.',
